...
$trim_max = get_op('post_word_max') ? get_op('post_word_max') : '100';
?>
		...
		<div class="normal_card_content">
            <div class="feature round12">
                <a href="<?php the_permalink(); ?>">
                    <img class="round12 shadow lazy" data-src="<?php echo cst_get_thum( get_the_ID(), 'large'); ?>" alt="">
                </a>
			</div>
            <div class="card_right">
                <div class="entry-content">
                    ...
                    <p><?php echo mb_strimwidth(strip_shortcodes(strip_tags(apply_filters('the_content', $post->post_content))), 0, $trim_max,"...");?></p>
